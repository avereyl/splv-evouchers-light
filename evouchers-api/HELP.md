...
* The original package name 'org.splv.evouchers-api' is invalid and this project uses 'org.splv.evouchers_api' instead.
...
```
$ docker run --rm -p 8080:8080 evouchers-api:0.0.1-SNAPSHOT
```
